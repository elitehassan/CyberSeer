import { type BotCommand, type ChatPermissions, type InlineQueryResult, type InputFile, type InputMedia, type InputMediaAudio, type InputMediaDocument, type InputMediaPhoto, type InputMediaVideo, type InputSticker, type LabeledPrice, type MaskPosition, type PassportElementError, type ReactionType } from "grammy/types";
import { type ApiClientOptions, type Methods, type Payload, type RawApi, type Transformer, type TransformerConsumer, type WebhookReplyEnvelope } from "grammy/out/core/client.js";
/**
...
import { AbortSignal } from "grammy/out/shim.node.js";
